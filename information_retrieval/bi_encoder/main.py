...
from information_retrieval.bi_encoder.callbacks.memory_callback import MemoryLoggerCallback
...
if __name__ == "__main__":
    ...
    test_results = model.evaluate(test_evaluator, output_path=args.record_output_path)
